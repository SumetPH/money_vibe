...
## การเปลี่ยนแปลงล่าสุด (พฤษภาคม 2026)

🚀 **Supabase Only Mode**
- แอปได้เปลี่ยนมาใช้งาน Supabase เป็นหลักเพียงอย่างเดียวเพื่อความง่ายในการซิงค์ข้อมูลข้ามอุปกรณ์
- ถอดระบบ SQLite และ Logic การสลับโหมดออกเพื่อลดความซับซ้อน
- ผู้ใช้ใหม่ต้องตั้งค่า Supabase URL และ Anon Key ก่อนเริ่มใช้งาน
